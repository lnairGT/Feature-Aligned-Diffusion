...
def generate_img(
    ...
    # Apply a simple mean filtering to generated images
    img_means = {
        0: 0.3036,
        1: 0.4749,
        2: 0.3937,
    ...
    for idx in tqdm(range(num_imgs)):
        print("Image num: ", idx)
        mean = 0.0
        while mean < target_mean - 0.1:  # Set a threshold of mean filtering
...
def visualize_img(
    imgs, baseline_imgs, filename, class_label, save_dir, save_individually=True
):
